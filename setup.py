...
VERSION = find_version('src', 'plugins', 'anayltics-plugin.py')

setup(
    name='astronomer-airflow-analytics-plugin',
    version=VERSION,
    url='https://github.com/astronomer/airflow-analytics-plugin',
    license='Apache2',
    author='astronomerio',
    author_email='humans@astronomer.io',
    description='Plugin for Astronomer Platform to retrieve analytics',
